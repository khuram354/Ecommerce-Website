...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <!-- 3rd child -->
        <div class="row">
            <div class="col-md-12 bg-secondary p-1 d-flex align-items-center flex-column flex-md-row">
                ...
                <div class="button text-center mt-3 mt-md-0">

                    <button class="my-3 border-0" <?php echo !isset($_SESSION['admin_name']) ? 'disabled' : ''; ?> onclick="return onButtonClick(event, 'insert_products.php');">
                        <span class="nav-link text-dark fw-bold bg-info m-1 px-2 py-1">Insert Products</span>
                    </button>

                    <button class="my-3 border-0" <?php echo !isset($_SESSION['admin_name']) ? 'disabled' : ''; ?> onclick="return onButtonClick(event, 'index.php?view_products');">
                        <span class="nav-link text-dark fw-bold bg-info m-1 px-2 py-1">View Product</span>
                    </button>

                    <button class="my-3 border-0" <?php echo !isset($_SESSION['admin_name']) ? 'disabled' : ''; ?> onclick="return onButtonClick(event, 'index.php?insert_category');">
                        <span class="nav-link text-dark fw-bold bg-info m-1 px-2 py-1">Insert
                            Categories</span></button>

                    <button class="my-3 border-0" <?php echo !isset($_SESSION['admin_name']) ? 'disabled' : ''; ?> onclick="return onButtonClick(event, 'index.php?view_categories');">
                        <span class="nav-link text-dark fw-bold bg-info m-1 px-2 py-1">View Categories</span>
                    </button>

                    <button class="my-3 border-0" <?php echo !isset($_SESSION['admin_name']) ? 'disabled' : ''; ?> onclick="return onButtonClick(event, 'index.php?insert_brand');">
                        <span class="nav-link text-dark fw-bold bg-info m-1 px-2 py-1">Insert Brands</span>
                    </button>

                    <button class="my-3 border-0" <?php echo !isset($_SESSION['admin_name']) ? 'disabled' : ''; ?> onclick="return onButtonClick(event, 'index.php?view_brands');">
                        <span class="nav-link text-dark fw-bold bg-info m-1 px-2 py-1">View Brands</span>
                    </button>

                    <button class="my-3 border-0" <?php echo !isset($_SESSION['admin_name']) ? 'disabled' : ''; ?> onclick="return onButtonClick(event, 'index.php?list_orders');">
                        <span class="nav-link text-dark fw-bold bg-info m-1 px-2 py-1">All Orders</span>
                    </button>

                    <button class="my-3 border-0" <?php echo !isset($_SESSION['admin_name']) ? 'disabled' : ''; ?> onclick="return onButtonClick(event, 'index.php?list_payments');">
                        <span class="nav-link text-dark fw-bold bg-info m-1 px-2 py-1">All Payments</span>
                    </button>

                    <button class="my-3 border-0" <?php echo !isset($_SESSION['admin_name']) ? 'disabled' : ''; ?> onclick="return onButtonClick(event, 'index.php?list_users');">
